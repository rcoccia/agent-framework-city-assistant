...
public class ActivitiesService
{
    ...
    public List<Activity> SearchActivities(string query)
    {
        ...
        return _activities.Where(a =>
            ...
            a.Category.ToLowerInvariant().Contains(normalizedQuery) ||
            a.Description.ToLowerInvariant().Contains(normalizedQuery) ||
            a.Location.ToLowerInvariant().Contains(normalizedQuery)
        ).ToList();
    }
}
